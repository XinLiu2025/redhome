...
import static com.rems.boot.enums.GenderEnum.MALE;
import static com.rems.boot.enums.UserStatusEnum.ACTIVE;
...
public class LoginController {
    ...
    public LayResult<Void> login(@RequestParam("username") String username, @RequestParam("password") String password, HttpServletRequest req) {
        ...
        if (userEntity != null) {
            ...
            result = LayResult.error("用户名或密码错误controller");
